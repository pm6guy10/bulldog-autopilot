...
// This is safe because this is a "use client" component and will only run in the browser.
...
export default function Page() {
  ...
  const handleDraftMotion = async () => {
    ...
    try {
      ...
      if (!response.ok) { const errData = await response.json(); throw new Error(errData.error || "Drafting request failed"); }
